...
To view your tiles, use the [mapgl](https://walker-data.com/mapgl/) package. PMTiles need HTTP range requests, so you'll want to start a local file server first:
