...
Published wheels include the native feature set, including DuckDB-backed file
input and SQL query support.

See the [Python Setup](python.html) article for detailed installation
instructions, virtual environment setup, and optional source builds.
